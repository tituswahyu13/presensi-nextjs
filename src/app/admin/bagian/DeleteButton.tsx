...
import { deleteBagian } from "@/app/actions/bagian";
...
export default function DeleteButton({ id }: { id: number }) {
  ...
  const handleDelete = async () => {
    ...
    const res = await deleteBagian(id);
    if (res.success) {
      setIsOpen(false);
      router.refresh();
    } else {
          ...
          <div className="bg-white rounded-xl shadow-xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-2">
                Apakah Anda yakin ingin menghapus divisi (bagian) ini? Data yang dihapus tidak akan ditampilkan lagi.
              </p>
